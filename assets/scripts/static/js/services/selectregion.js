...
document.getElementById("pais").onchange = function() {
    ...
    .then(data => {
        selectorci.innerHTML="<option  disabled selected>Seleccionar ciudad</option>";
        const results=data;
...
document.getElementById("pais2").onchange = function() {
    ...
    .then( tipoDeDato => tipoDeDato.json())
    .then(data => {
        selectorci2.innerHTML="<option  disabled selected>Seleccionar ciudad</option>";
        const results=data;
        results.forEach( contact => {
            const nombre=contact.NOMBRE_CIUDAD;
            const id=contact.ID;
...
document.getElementById("region").onchange = function() {
    ...
    .then( tipoDeDato => tipoDeDato.json())
    .then(data => {
        selectorpa.innerHTML="<option  disabled selected>Seleccionar país</option>";
        const results=data;
        results.forEach( contact => {
...
document.getElementById("region2").onchange = function() {
    ...
    .then( tipoDeDato => tipoDeDato.json())
    .then(data => {
        selectorpa2.innerHTML="<option  disabled selected>Seleccionar país</option>";
        const results=data;
        results.forEach( contact => {
            const nombre=contact.NOMBRE_PAIS;
            const id=contact.ID;
...
const selectorreg2=document.querySelector('#region2');
    ...
    .then( tipoDeDato => tipoDeDato.json())
    .then(data => {
        selectorreg.innerHTML="<option  disabled selected id='reg'>Seleccionar región</option>";
        const results=data;
        results.forEach( contact => {
    ...
    .then( tipoDeDato => tipoDeDato.json())
    .then(data => {
        selectorreg2.innerHTML="<option  disabled selected >Seleccionar región</option>";
        const results=data;
        results.forEach( contact => {
            const nombre=contact.NOMBRE_REGION;
            const id=contact.ID;
